<%@ Page Title="Kennwort zurücksetzen" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ResetPassword.aspx.cs" Inherits="hsDotNet.Account.ResetPassword" Async="true" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div class="form-horizontal">
        <h4>Geben Sie Ihr neues Kennwort ein.</h4>
        <hr />
